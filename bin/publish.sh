#!/usr/bin/zsh
echo "This script was used to do the initial subsplit; it should only be run if creating a new subsplit in the future."
exit 0

git subsplit publish "
    library/Zend/Authentication:git@github.com:zendframework/Component_ZendAuthentication.git
" --no-heads --tags " release-2.1.3 release-2.1.4"
git subsplit publish "
...
" --heads="master develop" --tags "release-2.0.8 release-2.1.4"
